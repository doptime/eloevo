...
var keyUseCase = redisdb.NewHashKey[string, *UseCase](redisdb.WithRds("usecase"), redisdb.WithKey("法规遵从AI助手服务"))
...
`))).WithToolCallLocked().WithTools(tool.NewTool("SolutionRefine", "Save sorted Items, Items represented as Id list.", func(model *prototype.SolutionRefinement_v250319) {
